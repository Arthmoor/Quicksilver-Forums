...
function error_fatal($type, $message, $file, $line = 0)
{
	...
	if( isset($set['admin_email']) ) {
		$headers = "From: Quicksilver Forums Error Module <{$set['admin_email']}>\r\n" . "X-Mailer: PHP/" . phpversion();

		$agent = isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : 'N/A';
		$ip    = isset($_SERVER['REMOTE_ADDR']) ? $_SERVER['REMOTE_ADDR'] : '127.0.0.1';

		$error_report = "Quicksilver Forums has exited with an error!\n";
		...
		@mail( $set['admin_email'], 'Quicksilver Forums Error Report', $error_report, $headers );
	}
...
<html xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en\">
 <head>
  ...
  <meta name=\"generator\" content=\"Quicksilver Forums\" />
 ...
 <div id=\"container\">
  ...
  <div id=\"main\">
   <div class=\"article\">
    ...
    The Quicksilver Forums software has experienced a fatal error and is unable to process your request at this time. Unfortunately any data you may have sent has been lost, and we apologize for the inconvenience.<br /><br />
 ...
 <div id=\"footer\">Powered by Quicksilver Forums &copy; 2006-2011 The Quicksilver Forums Development Team</div>
</body>
</html>" );
}
...
function error_notice($message)
{
	...
	// This will also email the user agent string, in case errors are being generated by evil bots.
	if( isset($set['admin_email']) ) {
		$mailer = new mailer($set['admin_email'], $set['admin_email'], 'Quicksilver Forums Error Module', false);
		$mailer->setSubject('Quicksilver Forums Notice Report');

		$agent = isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : 'N/A';
		$ip    = isset($_SERVER['REMOTE_ADDR']) ? $_SERVER['REMOTE_ADDR'] : '127.0.0.1';

		$error_report = "Quicksilver Forums triggered the following notice:\n\n";
