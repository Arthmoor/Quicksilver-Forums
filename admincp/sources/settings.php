...
class settings extends admin
{
	function execute()
	{
		...
		case 'update':
			...
			{
				if ($var == 'tos' || $var == 'meta_keywords' || $var == 'meta_description')
					continue;
			...
			if (isset($this->get['db'])) {
				...
				$this->write_sets();
				$this->db->query("UPDATE %psettings SET settings_tos='%s', settings_meta_keywords='%s', settings_meta_description='%s'", $tos_text, $meta_keywords, $meta_description);
			}
