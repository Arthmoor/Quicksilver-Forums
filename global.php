...
class qsfglobal
{
	...
	var $version = 1.52;              // Quicksilver Forums' version @var string
	...
	{
		$settings = $this->db->fetch("SELECT settings_meta_keywords, settings_meta_description, settings_data FROM %psettings LIMIT 1");
